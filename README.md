...
Current slice: Qwen Image 2.1 stills (POST id flux1-dev-q4) and ACE music (10–90 seconds). Fast is 8 steps, Detail is 20, CFG 1. Director writes ACE or drops a track, then one Qwen still and a WAN 2.2 5B last-frame chain. Saved remote effective settings remain attached to the job.
