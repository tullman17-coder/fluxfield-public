  ...
  return (
    <div className="grid gap-8 lg:grid-cols-[minmax(280px,360px)_1fr]">
      ...
      <div className="space-y-4">
        {!job ? (
          <div className="flex min-h-64 items-center justify-center rounded-2xl border border-dashed border-white/10 text-sm text-zinc-500">
          ...
          <>
            <div className="rounded-2xl border border-white/10 bg-white/[0.03] p-4">
              ...
              {job.script ? (
                <pre className="mt-3 max-h-48 overflow-auto whitespace-pre-wrap rounded-xl bg-black/40 p-3 text-xs text-zinc-300">
                  {job.script}
                </pre>
              ) : null}
            </div>
            <div className="grid gap-3 sm:grid-cols-2">
              ...
              {job.outputs
                ...
                .map((o) => (
                  <pre
                    key={o.id}
                    className="rounded-2xl border border-white/10 bg-black/40 p-4 text-xs text-zinc-300 whitespace-pre-wrap sm:col-span-2"
                  >
                    {o.label}
                    {"\n"}
                    {o.text}
