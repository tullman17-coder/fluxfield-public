...
export const IMAGE2_WRAPPERS: Image2Wrapper[] = [
  {
    ...
    inputs: [
      ...
      },
      {
        ...
        type: "textarea",
        required: true,
        placeholder: "Blue hoodie, yellow smiley graphic, night flash photo",
      },
      {
        id: "cta",
        label: "CTA",
        type: "text",
        placeholder: "Shop Drop 04 →",
      },
      {
        id: "referenceImage",
    ...
    aspectDefault: "9:16",
    copyHints: ["NEW DROP", "Shop CTA", "Sticker overlays"],
  },
  {
    slug: "editorial-catalog",
    name: "Editorial Catalog",
    brandSample: "M. ATELIER",
    ...
    inputs: [
      ...
      },
      {
        ...
        type: "text",
        required: true,
        placeholder: "Curve Lounge Chair",
      },
      {
        id: "productDescription",
        ...
        type: "textarea",
        required: true,
        placeholder: "Powder-blue lounge chair, corgi perched, soft daylight loft",
      },
      {
        id: "headline",
        label: "Headline",
        type: "text",
        placeholder: "Sit Better. or sit on the floor.",
      },
      {
        id: "bodyCopy",
        label: "Body copy",
        type: "textarea",
        placeholder: "Crafted for rooms that refuse compromise…",
      },
    ],
    presets: [
      {
  ...
  },
  {
    ...
    inputs: [
      ...
      },
      {
        ...
        type: "textarea",
        required: true,
        placeholder: "Mohawk figure, yellow sunglasses, xerox texture",
      },
      {
        id: "venue",
        label: "Venue details",
        type: "textarea",
        placeholder: "Hall 4 Gallery · Berlin · Fri 21:00",
      },
    ],
    presets: [
      {
  ...
  },
  {
    ...
    inputs: [
      ...
      },
      {
        ...
        type: "textarea",
        required: true,
        placeholder: "Strawberry bowl, sun-face mug, soft peach backdrop",
      },
      {
        id: "price",
        label: "From price",
  ...
  },
  {
    ...
    inputs: [
      ...
      },
      {
        ...
        type: "textarea",
        required: true,
        placeholder: "Streetwear capsule: denim, bomber, sneakers",
      },
      {
        id: "cta",
        label: "Primary CTA",
  ...
  },
  {
    ...
    inputs: [
      ...
      },
      {
        ...
        type: "text",
        required: true,
        placeholder: "Home Jersey Portrait",
      },
      {
        id: "productDescription",
        label: "Look",
        type: "textarea",
        required: true,
        placeholder: "Anime-style athlete in baseball jersey, bold calligraphy",
      },
    ],
    presets: [
      {
