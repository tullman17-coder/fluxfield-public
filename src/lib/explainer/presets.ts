...
export const EXPLAINER_PRESETS: ExplainerPreset[] = [
  ...
  },
  {
    ...
    styleAlias: "Qwen 2.1 · Watercolor",
  ...
  },
  {
    ...
    styleAlias: "Qwen 2.1 · Paper Diorama",
